...
#region Table Dimensions
    public float TABLE_WIDTH = 1.0668f;
    public float TABLE_HEIGHT = 0.6096f; 
    public Vector3 CORNER_POCKET = new Vector3(1.087f, 0.0f, 0.63f);
    public Vector3 MIDDLE_POCKET = new Vector3(0.0f, 0.0f, 0.662f);
    public float POCKET_RADIUS = 0.09f;
    public float POCKET_INNER_RADIUS = 0.072f;
